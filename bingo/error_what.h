...
enum {
	...
	ERROR_TYPE_TCP_SERVER_CLOSE_SOCKET_BY_SERVER				= 0x09,
                ERROR_TYPE_TCP_SERVER_CLOSE_SOCKET_BY_SSL				= 0x0F,
	...
	ERROR_TYPE_RABBITMQ_MAKE_WORK_RECEIVER_FAIL				= 0x67,
                     ERROR_TYPE_RABBITMQ_MAKE_PUBLISH_SENDOR_FAIL				= 0x68,
	ERROR_TYPE_RABBITMQ_MAKE_PUBLISH_RECEIVER_FAIL				= 0x69,
                     ERROR_TYPE_RABBITMQ_MAKE_ROUTING_SENDOR_FAIL				= 0x6A,
	ERROR_TYPE_RABBITMQ_MAKE_ROUTING_RECEIVER_FAIL				= 0x6B,
                     ERROR_TYPE_RABBITMQ_MAKE_TOPIC_SENDOR_FAIL				= 0x6C,
	ERROR_TYPE_RABBITMQ_MAKE_TOPIC_RECEIVER_FAIL				= 0x6D,
