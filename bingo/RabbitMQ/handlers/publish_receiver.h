...
#ifndef BINGO_RABBITMQ_HANDLERS_PUBLISH_RECEIVER_H_
#define BINGO_RABBITMQ_HANDLERS_PUBLISH_RECEIVER_H_
...
class publish_receiver : public rb_receiver {
public:
	publish_receiver(const char* cfg_file);
	virtual ~publish_receiver();
...
#endif /* BINGO_RABBITMQ_HANDLERS_PUBLISH_RECEIVER_H_ */
