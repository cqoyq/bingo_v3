...
#ifndef BINGO_RABBITMQ_HANDLERS_ROUTING_SENDOR_H_
#define BINGO_RABBITMQ_HANDLERS_ROUTING_SENDOR_H_
...
class routing_sendor : public rb_sendor {
public:
	routing_sendor(const char* cfg_file);
	virtual ~routing_sendor();
...
private:
	config::rb_routing_sendor_cfg cfg_;
...
#endif /* BINGO_RABBITMQ_HANDLERS_ROUTING_SENDOR_H_ */
