...
bool rb_recevier_cfg::read_xml( const char* cfg_file ) {
...
rb_routing_recevier_cfg::rb_routing_recevier_cfg( ) : rb_recevier_cfg( ) {

}

rb_routing_recevier_cfg::~rb_routing_recevier_cfg( ) {

}

bool rb_routing_recevier_cfg::check_node( ) {
          ...
          //				<host>/</host>								// rabbitmq's host
          //				<exchange>hello</exchange>			// rabbitmq's exchange
          //				<routingkey>hello1,hello1</routingkey>		// rabbitmq's routingkey
          //		</rabbitmq_receiver>
          //	</application>
          string s_type;
          if ( !xml_.get_value( "application.rabbitmq_receiver.type" , s_type ) ) {
          ...
          // Splite routingkeys.
          split( routingkeyset , value.routingkey , is_any_of( "," ) , token_compress_on );
