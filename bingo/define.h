...
#define RABBITMQ_MAPKEY_MAX_SIZE 20
#define RABBITMQ_SINGLE_SENDOR_ERROR 	"rabbitmq_single_sendor_error"
#define RABBITMQ_SINGLE_SENDOR_INFO 		"rabbitmq_single_sendor_info"
#define RABBITMQ_SINGLE_RECEIVER_ERROR 	"rabbitmq_single_receiver_error"
#define RABBITMQ_SINGLE_RECEIVER_INFO 		"rabbitmq_single_receiver_info"
