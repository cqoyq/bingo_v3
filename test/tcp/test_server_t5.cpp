...
public:
	...
	int read_pk_full_complete_func(
		...
		string_ex t;
		message_out_with_thread( ",hdr:" << p.get() << ",do read_pk_full_complete_func(), data:" <<
				t.stream_to_string(rev_data, rev_data_size));


		e_what.err_no(ERROR_TYPE_TCP_PACKAGE_BODY_IS_ERROR);
		e_what.err_message("package body is error!");
...
BOOST_AUTO_TEST_CASE(t_server){
	...
	// ouput:
	//	2017-02-21T16:23:50,thr_id:403eec0,call start_accept()
	//	2017-02-21T16:23:50,thr_id:403eec0,set heartjump time:2017-02-21T16:23:50.784780,hdr:0x8388070
	//	2017-02-21T16:23:50,thr_id:403eec0,set authentication pass time:2017-02-21T16:23:50.801220,hdr:0x8388070
	//
	//	2017-02-21T16:23:57,thr_id:403eec0,call accept_handler()
	//	2017-02-21T16:23:57,thr_id:403eec0,,hdr:0x8388070,do accept_success_insert_handler_mgr()
	//	2017-02-21T16:23:57,thr_id:403eec0,set authentication pass time:2017-02-21T16:23:57.424562,hdr:0x8388070

	//	2017-02-21T16:23:57,thr_id:403eec0,call start_accept()
	//	2017-02-21T16:23:57,thr_id:403eec0,set heartjump time:2017-02-21T16:23:57.494429,hdr:0x838bed0
	//	2017-02-21T16:23:57,thr_id:403eec0,set authentication pass time:2017-02-21T16:23:57.495844,hdr:0x838bed0

	//	hdr:0x8388070,do read_pk_header_complete_func(), header data:68 33 00 05
	//	2017-02-21T16:23:57,thr_id:403eec0,,hdr:0x8388070,do read_pk_full_complete_func(), data:68 33 00 05 d9 8c ee 47 16 01 01 8f 72 d8 0d 16
	//	2017-02-21T16:23:57,thr_id:403eec0,,hdr:0x8388070,err_code:4,do catch_error()						// error_no : ERROR_TYPE_TCP_PACKAGE_BODY_IS_ERROR
	//	2017-02-21T16:23:57,thr_id:403eec0,,hdr:0x8388070,do close_completed_erase_hander_mgr(),success
	//	2017-02-21T16:23:57,thr_id:403eec0,handler:0x8388070,destory!
